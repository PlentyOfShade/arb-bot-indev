...
const arbFor = web3.utils.toChecksumAddress(process.env.ARB_FOR); // This is the address of token we are attempting to arbitrage (WETH)
const arbAgainst = process.env.ARB_AGAINST; // SAND
